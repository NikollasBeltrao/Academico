<html>
    <head>
        ...
        session_start();
        $alterarC = '';
        if (isset($_SESSION['sesAlterarC'])) {
            $alterarC = $_SESSION['sesAlterarC'];
        }
        session_abort();
        ?>
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-striped table-dark">
                                            ...
                                            <tbody>
                                                <?php
                                                $cursos = listCursos();
                                                foreach ($cursos as $cusAlrso) {
                                                    echo '<tr>
                                                <td>' . $cusAlrso->getId() . '</td>
                                                <td>' . $cusAlrso->getNome() . '</td>
                                                <td>' . $cusAlrso->getAbreviacao() . '</td>
                                                </tr>  ';
                                                }
                                                ?>
                                            </tbody>
                    ...
                    <div class="tab-pane fade" id="cadastrar" >
                        <div class="col-xl-12 col-lg-12">
                            <div class="card shadow mb-4">
                                ...
                                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                                    <h6 class="m-0 font-weight-bold text-primary">
                                        Cadastrar um curso</h6>
                                </div>
                                <!-- Card Body -->
                                <div class="card-body">
                                    <form action="control/cadastrarCurso.php" method="post">                                    
                                        <div class="form-row">
                                            <div class="form-group">
                                                <label for="inpNomeC">Nome</label>
                                                <input type="text" class="form-control" name="inpNomeC" placeholder="Nome completo">
                                            </div>
                                            <div class="form-group">
                                                <label for="inpAbrevC">Abreviação</label>
                                                <input type="text" class="form-control" name="inpAbrevC" placeholder="Abreviação">
                                            </div>
                                        </div>
                    ...
                    <div class="tab-pane fade" id="alterar">
                        <div class="col-xl-12 col-lg-12">
                            <div class="card shadow mb-4">
                                ...
                                $AltTrue = false;
                                if ($alterarC != '') {
                                    $cursoAlt = getCurso($alterarC);
                                    if ($cursoAlt[0] == 'false') {
                                        $AltTrue = false;
                                        $erroMessage = 'Curso não encontrado';
                                    } else {
                                        $AltTrue = true;
                                    }
                                }
                                ...
                                <div class="card-body">
                                    <div class="form-inline" >
                                        <form class="form-group" action="" method="post">
                                            <label for="inpMatAltC">Matrícula</label>
                                            <input type="text" name="inpMatAltC" id="inpAlterar" class="form-control mx-sm-3" 
                                                   value="<?php echo $alterarC; ?>">
                        ...
                        <div class="col-xl-12 col-lg-12">
                            <div class="card shadow mb-4">
                                ...
                                <!-- Card Body -->
                                <div class="card-body">
                                    <form action="control/alterarCurso.php" method="post">
                                        <input type="text" name="inpIdC" value="<?php if ($AltTrue) echo $alterarC; ?>" style="display: none">
                                        <div class="form-group">
                                            <label for="inpNomeC">Nome</label>
                                            <input type="text" class="form-control" name="inpNomeC"
                                                   value="<?php if ($AltTrue) echo $cursoAlt[1]->getNome(); ?>">
                                        </div>
                                        <div class="form-row">
                                            <div class="form-group col-md-6">
                                                <label for="inpAbrevC">Abreviação</label>
                                                <input type="text" class="form-control" name="inpAbrevC"
                                                       value="<?php if ($AltTrue) echo $cursoAlt[1]->getAbreviacao(); ?>">
                                            </div>
                                        </div>                                     
